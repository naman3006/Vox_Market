...
export class TwoFactorAuthenticationService {
  ...
  public async generateTwoFactorAuthenticationSecret(
    ...
    console.log(
      `[DEBUG] Generated 2FA Secret: ${secret.base32} for User ID: ${user._id || user.id}`,
    );
  ...
  public isTwoFactorAuthenticationCodeValid(
    ...
    console.log(
      `[DEBUG] Verifying Code: ${twoFactorAuthenticationCode} for User Secret: ${user.twoFactorAuthenticationSecret}`,
    );
